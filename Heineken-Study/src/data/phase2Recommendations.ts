...
export const phase2Recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    evidence: "Corona's share advantage over Heineken is partly attributable to appearance: 17.9% of Corona buyers cited packaging/design vs 4% of Heineken buyers. Corona's vitamin D visual messaging is a meaningful differentiator that Heineken currently lacks.",
