...
export const phase2Hypotheses: Phase2HypothesisOutcome[] = [
  {
    ...
    statement: 'Mother brand will be chosen more frequently in the simulated purchase environment compared to non-mother-brand competitors.',
  ...
  },
  {
    ...
    outcome: 'partial',
    outcomeLabel: 'Partially Supported'
  },
  {
    id: 'H3',
